...
#    basepath = "D:\hidra"
    ...
    platform_specific_files = [
        (os.path.join(senderpath, "eventDetectors", "inotifyx_detector.py"),
            os.path.join("eventDetectors", "inotifyx_detector.py")),
        (os.path.join(senderpath, "eventDetectors", "watchdog_detector.py"),
            os.path.join("eventDetectors", "watchdog_detector.py")),
        (os.path.join(senderpath, "eventDetectors", "http_detector.py"),
            os.path.join("eventDetectors", "http_detector.py")),
        (os.path.join(senderpath, "eventDetectors", "zmq_detector.py"),
            os.path.join("eventDetectors", "zmq_detector.py")),
...
#    basepath = "/opt/hidra"
    ...
    platform_specific_files = [
        (os.path.join(senderpath, "eventDetectors", "inotifyx_detector.py"),
            "inotifyx_detector.py"),
        (os.path.join(senderpath, "eventDetectors", "watchdog_detector.py"),
            "watchdog_detector.py"),
        (os.path.join(senderpath, "eventDetectors", "http_detector.py"),
            "http_detector.py"),
        (os.path.join(senderpath, "eventDetectors", "zmq_detector.py"),
            "zmq_detector.py"),
